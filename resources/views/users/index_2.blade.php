                            ...
                            <tbody class="list form-check-all">
                                @foreach($users as $key => $user)
                                    <tr>
                                        <th scope="row">
                                            <div class="form-check"> 
                                                <input class="form-check-input" type="checkbox" name="selected_row" data-id="{{ $user->id }}"
                                                   value="{{ $user->id }}">
                                            </div>
                                        </th>
                                        <td class="id1"><a href="apps-ecommerce-order-details" class="fw-medium link-primary">{{$loop->iteration}}</a></td>
                                        <td class="customer_name">{{ $user->name }}</td>
                                        <td class="product_name">{{ $user->email }}</td>
                                        <td class="date">{{ implode(",",$user->getRoleNames()->toArray())}}
                                        </td>
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                ...
                                                <li  class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                    <a data-id="{{ $user->id }}" class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal" href="#deleteOrder">
