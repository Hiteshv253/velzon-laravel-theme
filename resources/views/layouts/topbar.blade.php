    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                @include('layouts.features.language')
                @include('layouts.features.web-app')
                @include('layouts.features.my-cart')
                @include('layouts.features.fullscreen')
                @include('layouts.features.light-dark-mode')
